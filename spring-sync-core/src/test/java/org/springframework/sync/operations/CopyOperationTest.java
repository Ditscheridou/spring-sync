...
class CopyOperationTest {
  ...
  @Test
  void copyBooleanPropertyValueIntoStringProperty() {
    // initial Todo list
    List<Todo> todos = new ArrayList<Todo>();
    todos.add(new Todo(1L, "A", true));
    todos.add(new Todo(2L, "B", false));
  ...
  @Test
  void copyListElementToBeginningOfList() {
    // initial Todo list
    List<Todo> todos = new ArrayList<Todo>();
    ...
    assertEquals(2L, todos.get(0).getId()
        .longValue()); // NOTE: This could be problematic if you try to save it to a DB because there'll be duplicate IDs
    assertEquals("B", todos.get(0).getDescription());
    assertTrue(todos.get(0).isComplete());
  }

  @Test
  void copyListElementToMiddleOfList() {
    // initial Todo list
    List<Todo> todos = new ArrayList<Todo>();
    todos.add(new Todo(1L, "A", true));
    todos.add(new Todo(2L, "B", false));
    ...
    assertEquals(4, todos.size());
    assertEquals(1L, todos.get(2).getId()
        .longValue()); // NOTE: This could be problematic if you try to save it to a DB because there'll be duplicate IDs
  ...
  @Test
  void copyListElementToEndOfList_usingIndex() {
    // initial Todo list
    List<Todo> todos = new ArrayList<Todo>();
    todos.add(new Todo(1L, "A", true));
    todos.add(new Todo(2L, "B", false));
    ...
    assertEquals(4, todos.size());
    assertEquals(1L, todos.get(3).getId()
        .longValue()); // NOTE: This could be problematic if you try to save it to a DB because there'll be duplicate IDs
  ...
  @Test
  void copyListElementToEndOfList_usingTilde() {
    // initial Todo list
    List<Todo> todos = new ArrayList<Todo>();
    todos.add(new Todo(1L, "A", true));
    todos.add(new Todo(2L, "B", false));
    ...
    assertEquals(4, todos.size());
    assertEquals(new Todo(1L, "A", true), todos.get(
        3)); // NOTE: This could be problematic if you try to save it to a DB because there'll be duplicate IDs
  }

  @Test
  void copyListElementFromEndOfList_usingTilde() {
    // initial Todo list
    List<Todo> todos = new ArrayList<Todo>();
    todos.add(new Todo(1L, "A", true));
    todos.add(new Todo(2L, "B", false));
    ...
    assertEquals(4, todos.size());
    assertEquals(new Todo(3L, "C", false), todos.get(
        0)); // NOTE: This could be problematic if you try to save it to a DB because there'll be duplicate IDs
  }
